  ...
  try {
    ...
    if (response.ok) {
      ...
      document.getElementById(
        "profile-title"
      ).textContent = `${user.fullname}'s Profile`;
      ...
      document.getElementById("display-nationality").textContent =
        user.nationality || "Not provided";
      document.getElementById("display-dob").textContent = user.dob
      ...
      document.getElementById("updateNationality").value =
        user.nationality || "";
      ...
      if (user.dob) {
        ...
        document.getElementById("updateDob").value = date
          .toISOString()
          .split("T")[0];
      }
